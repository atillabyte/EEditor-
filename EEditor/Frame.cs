                        ...
                        if (xx != null && yy != null)
                        {
                            for (int xxx = 0; xxx < xx.Length; xxx += 2)
                            {
                                ...
                                if (layer == 0)
                                {
                                    ...
                                    if (worldinfo.TryGetValue("goal", out var goal)) frame.BlockData[tmpyy, tmpxx] = Convert.ToInt32(worldinfo["goal"]);
                                    if (worldinfo.TryGetValue("signtype", out var signtype)) frame.BlockData[tmpyy, tmpxx] = Convert.ToInt32(worldinfo["signtype"]);
                                    if (worldinfo.TryGetValue("text", out var text)) frame.BlockData3[tmpyy, tmpxx] = worldinfo["text"].ToString();
                                    if (worldinfo.TryGetValue("rotation", out var rotation)) frame.BlockData[tmpyy, tmpxx] = Convert.ToInt32(worldinfo["rotation"]);
                                    if (worldinfo.TryGetValue("id", out var id)) frame.BlockData1[tmpyy, tmpxx] = Convert.ToInt32(worldinfo["id"]);
                        ...
                        if (xx1 != null && yy1 != null)
                        {
                            for (int xxxx = 0; xxxx < xx1.Length; xxxx++)
                            {
                                ...
                                if (layer == 0)
                                {
                                    ...
                                    if (worldinfo.TryGetValue("goal", out var goal)) frame.BlockData[tmpyy0, tmpxx0] = Convert.ToInt32(worldinfo["goal"]);
                                    if (worldinfo.TryGetValue("signtype", out var signtype)) frame.BlockData[tmpyy0, tmpxx0] = Convert.ToInt32(worldinfo["signtype"]);
                                    if (worldinfo.TryGetValue("text", out var text)) frame.BlockData3[tmpyy0, tmpxx0] = worldinfo["text"].ToString();
                                    if (worldinfo.TryGetValue("rotation", out var rotation)) frame.BlockData[tmpyy0, tmpxx0] = Convert.ToInt32(worldinfo["rotation"]);
                                    if (worldinfo.TryGetValue("id", out var id)) frame.BlockData1[tmpyy0, tmpxx0] = Convert.ToInt32(worldinfo["id"]);
                                    if (worldinfo.TryGetValue("target", out var target))
                                    {
                            ...
                            for (int j = 0; j < x1.Length; j++)
                            {
                                if (y1[j] < height && x1[j] < width)
                                {
                                    if (Convert.ToInt32(obj["type"]) < 500 || Convert.ToInt32(obj["type"]) >= 1001) {
                                        ...
                                        if (obj.TryGetValue("goal", out var goal)) f.BlockData[y1[j], x1[j]] = Convert.ToInt32(obj["goal"]);
                                        if (obj.TryGetValue("signtype", out var signtype)) f.BlockData[y1[j], x1[j]] = Convert.ToInt32(obj["signtype"]);
                                        if (obj.TryGetValue("text", out var text)) f.BlockData3[y1[j], x1[j]] = obj["text"].ToString();
                                        if (obj.TryGetValue("rotation", out var rotation)) f.BlockData[y1[j], x1[j]] = Convert.ToInt32(obj["rotation"]);
                                        if (obj.TryGetValue("id", out var id)) f.BlockData1[y1[j], x1[j]] = Convert.ToInt32(obj["id"]);
                                        if (obj.TryGetValue("target", out var target)) f.BlockData2[y1[j], x1[j]] = Convert.ToInt32(obj["target"]);
                            ...
                            for (int k = 0; k < x.Length; k += 2)
                            {
                                ...
                                if (yy < height && xx < width)
                                {
                                    if (Convert.ToInt32(obj["type"]) < 500 || Convert.ToInt32(obj["type"]) >= 1001)
                                    {
                                        ...
                                        if (obj.TryGetValue("goal", out var goal)) f.BlockData[yy, xx] = Convert.ToInt32(obj["goal"]);
                                        if (obj.TryGetValue("signtype", out var signtype)) f.BlockData[yy, xx] = Convert.ToInt32(obj["signtype"]);
                                        if (obj.TryGetValue("text", out var text)) f.BlockData3[yy, xx] = obj["text"].ToString();
                                        if (obj.TryGetValue("rotation", out var rotation)) f.BlockData[yy, xx] = Convert.ToInt32(obj["rotation"]);
                                        if (obj.TryGetValue("id", out var id)) f.BlockData1[yy, xx] = Convert.ToInt32(obj["id"]);
                                        if (obj.TryGetValue("target", out var target)) f.BlockData2[yy, xx] = Convert.ToInt32(obj["target"]);
                                    }
                                    else if (Convert.ToInt32(obj["type"]) >= 500 && Convert.ToInt32(obj["type"]) <= 999)
                                    {
